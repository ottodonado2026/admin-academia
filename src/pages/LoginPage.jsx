...
function LoginPage() {
  ...
  useEffect(() => {
    ...
    } else if (["owner", "admin", "contador", "gerente", "super_admin"].includes(role)) {
  ...
  return (
    <>
      ...
      <div className={`login-page-wrapper ${fade ? "fade-out" : ""}`}>
        ...
        <div className="login-left">
          <div className="login-left-content">
            ...
            <h1 className="login-heading">
              Un sistema.<br />
              <span className="text-highlight">Dos mundos.</span>
            </h1>
            
            <p className="login-subheading">
              La plataforma integral que transforma la gestión de {config.nombre}, haciéndola más eficiente, segura e intuitiva.
            </p>
            ...
            <div className="features-list">
              <div className="feature-item">
                ...
                <div>
                  ...
                  <p>Protegemos tu información y la de tus estudiantes.</p>
                </div>
              </div>
              <div className="feature-item">
                <div className="feature-icon">
                ...
                <div>
                  ...
                  <p>Diseñado para que todo sea más fácil y eficiente.</p>
                </div>
              </div>
              <div className="feature-item">
                <div className="feature-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 18v-6a9 9 0 0118 0v6" stroke="#0f62fe" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M21 19a2 2 0 01-2 2h-1v-4h3v2zM3 19a2 2 0 002 2h1v-4H3v2z" stroke="#0f62fe" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </div>
                <div>
                  <h4>Soporte real</h4>
        ...
        {/* Lado Derecho: Formulario de Colegio */}
        <div className="login-right">
          <div className="login-card">
            ...
            <div className="login-card-header">
               ...
               <h2>Bienvenido a {config.nombre}</h2>
            ...
            <div className="login-demo-info">
              <div className="demo-badge">INFO</div>
              admin@test.com / 123456
            </div>

            <div className="login-card-footer">
              <div className="login-alt-buttons">
                <button type="button" onClick={() => { setFade(true); setTimeout(() => navigate("/login-profesor"), 300); }}>
                  👨‍🏫 Portal Docente
                </button>
              </div>
            </div>
